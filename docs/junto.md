...
- **(b)** Spec the **ledger-entry content model** concretely (the durable record's "why"), with the human-ratified/verified guardrail + per-playbook verifier baked in. *(open — strong candidate for next deep work)*
